...
from keras.api.layers import GRU, Input, Flatten, Dense, Dropout
...
model.add(GRU(256, return_sequences=True, kernel_initializer=init))
model.add(Dropout(dr))
model.add(GRU(128, return_sequences=True, kernel_initializer=init))
model.add(Flatten())
...
history = model.fit(
    ...
    batch_size=32,
    callbacks=[
        ModelCheckpoint('models/test_GRU.keras', verbose=2, save_best_only=True, mode='auto'),
